...
\item Handle basic statistical inquiries; investigate and implement advanced methodologies 
\item Conduct power analyses via exact methods or simulations
\item Develop intiutive data visualizations to communicate experimental outcomes
\item Apply machine learning algorithms to extract knowledge from high dimensional data sets
\item Research, implement and compare pipelines for the analysis of NGS data
\item Research and implement tools for integrated analysis of multiple high-throughput genomic, transcriptomic and proteomic assays
\item Deploy and administer GitLab backed git version control system to improve project tracking and project reproducibility
\end{rSubsection}
